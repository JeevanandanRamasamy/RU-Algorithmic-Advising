...
/**
 * A component to display a requirement tree with labeled courses for a specific program.
 * The tree structure includes expandable nodes to show required courses and groups of requirements.
 */
const RequirementTree = ({ programId, username }) => {
	...
	// Fetch requirement tree data when component is mounted or programId changes
	useEffect(() => {
	...
	// Render the tree recursively with expandable nodes

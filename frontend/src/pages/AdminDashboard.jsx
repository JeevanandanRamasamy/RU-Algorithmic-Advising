...
// AdminDashboard component provides an overview for admin users.
...
// Redirect logic to ensure only admins can access the dashboard
	useEffect(() => {
 ...
 // Fetch the most and least popular courses on component mount
	useEffect(() => {

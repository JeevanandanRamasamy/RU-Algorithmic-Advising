...
// Component for reseting passwords
	...
	return (
		<div className="flex min-h-screen">
			...
			<div className="flex flex-col justify-center flex-1 px-8 py-12 lg:px-24">
				<img
					src={logo}
					alt="RU Super Scheduler"
					className="w-20 mx-auto"
				/>
				<h1 className="mt-6 text-3xl font-bold text-center">Reset Your Password</h1>
				<p className="mt-2 text-center text-gray-600">Let’s get you back in</p>

				{message && <div className="mt-6 text-center text-red-600">{message}</div>}
